-- Top Down Shooter Game - Enhanced Modular Version
...
function love.draw()
    ...
    -- Draw UI
    game.ui:draw(game.player, game.DEBUG, game.player.walkingFrameTime, game.player.walkingFrameDuration, game.assets.soldierWalkingImages)
